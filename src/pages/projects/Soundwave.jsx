    ...
    <div className="py-24 border-b border-white/20 px-2 relative flex flex-col xl:flex-row justify-between items-start gap-12 w-full">
      <div className="z-10 flex-shrink-0">
        ...
        <div className="font-reddit text-sm md:text-base leading-relaxed tracking-wider">
          ...
          <div><span className="text-blue-400">String[]</span> tech = {"{"}{techStack.join(", ")}{"}"};</div>
          <div>
            <span className="text-blue-400">URL</span> frontend = <a href="https://github.com/Krymmel-Kaemperne/SpinchyFrontend" target="_blank" rel="noopener noreferrer" className="text-orange-300 hover:text-blue-400 underline decoration-white/10">"frontend-repo"</a>;
          </div>
          <div>
            <span className="text-blue-400">URL</span> backend = <a href="https://github.com/Krymmel-Kaemperne/soundwave-backend" target="_blank" rel="noopener noreferrer" className="text-orange-300 hover:text-blue-400 underline decoration-white/10">"backend-repo"</a>;
          </div>
      ...
      <div className="relative z-20 w-full xl:w-[60%] max-w-[900px] self-center">
        <div className="bg-[#1a1a1a] w-full h-10 rounded-t-2xl border-x border-t border-white/20 flex items-center px-6 gap-3">
          ...
          <div className="ml-4 text-[10px] text-white/20 font-reddit uppercase tracking-[0.2em]">soundwave-arena.app</div>
        </div>
        
        <div className="w-full aspect-video bg-white rounded-b-2xl border-x border-b border-white/20 overflow-hidden">
          <img 
            src="/Screenshots/Soundwave.png" 
            alt="Soundwave Project" 
